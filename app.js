...
const HEARTBEAT_REFRESH_INTERVAL =
    2000;
    ...
    try {
        ...
        result.innerHTML = `
            ...
            <div class="card">
                ...
                <p>
                    <strong>类型：</strong>
                    ${getCardType(data.duration_days)}
                </p>
